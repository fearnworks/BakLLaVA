...
def save_prompt_values(prompt_values):
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                with gr.Tabs():
                    ...
                    with gr.Tab("Predefined Responses"):
                        with gr.Column():
                            ...
                            predefined_response_2 = gr.Textbox(
                                label="Response 2",
                                value="special segmentation keyword",
                    ...
                    with gr.Tab("System Prompt"):
                        ...
                        use_system_prompt = gr.Checkbox(
                            label="Use System Prompt", value=False
                        )
